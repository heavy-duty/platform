...
Then, use the Drill CLI to create the board, using the next command inside the monorepo. But first, lets create a new wallet and fund it with some SOLs, you'll need this later in the process.
...
**NOTE**: _SOLANA_SECRET_KEY_ is the secret key from the Solana wallet previous created for the board.
...
```text
PROGRAM_ID=DR1LL87tP9uZqPXTxGDVrVE53zrLTBei3YLKrx4ihYh1
GITHUB_CLIENT_ID=Iv1.9c188bde8bcb34f6
GITHUB_CLIENT_SECRET=8ac0bdb013b0acaff1b89e238d41102187485789
