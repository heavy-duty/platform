...
pub mod bulldozer {
    ...
    pub fn delete_instruction_basic_account(ctx: Context<DeleteInstructionBasicAccount>) -> ProgramResult {
    ...
    pub fn delete_instruction_program_account(ctx: Context<DeleteInstructionProgramAccount>) -> ProgramResult {
    ...
    pub fn delete_instruction_signer_account(ctx: Context<DeleteInstructionSignerAccount>) -> ProgramResult {
