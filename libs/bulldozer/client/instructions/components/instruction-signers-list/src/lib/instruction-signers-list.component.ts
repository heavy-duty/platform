...
export class InstructionSignersListComponent {
  ...
  @Input() set instructionId(value: string | undefined) {
    this._instructionSignersListStore.setInstructionId(value);
  }
  readonly instructionId$ = this._instructionSignersListStore.instructionId$;
  readonly instructionSigners$ =
    this._instructionSignersListStore.instructionSigners$;

  constructor(
    private readonly _instructionSignersListStore: InstructionSignersListStore,
