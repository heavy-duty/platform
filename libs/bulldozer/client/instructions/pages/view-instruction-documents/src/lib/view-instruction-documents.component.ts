  ...
  template: `
    ...
    <main *ngrxLet="documents$; let documents" class="pb-20">
      ...
      >
        ...
        >
          <aside class="flex items-center bg-bd-black px-4 py-1 gap-1">
          ...
          <header class="flex items-center gap-4 p-4">
            <div
              class="w-12 h-12 flex justify-center items-center bg-bd-black rounded-full"
            >
              <mat-icon
                class="w-1/2"
                [ngClass]="{
          ...
          <section class="p-4" *hdWalletAdapter="let publicKey = publicKey">
            ...
            <div class="flex justify-start flex-wrap gap-4">
              ...
              >
                <div
                  class="flex justify-between items-center gap-2 bg-bd-black px-8 py-2"
